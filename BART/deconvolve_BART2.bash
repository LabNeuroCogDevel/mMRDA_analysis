...
3dDeconvolve                                           \
      ...
      \
      -stim_times 7 Reward_pump_times.1D 'BLOCK5(1,1)' \
      -stim_label 7 RewardPump                              \
      -stim_times 8 Reward_cash_times.1D 'BLOCK5(1,1)' \
      -stim_label 8 RewardCash                     \
      -stim_times 9 Reward_burst_times.1D 'BLOCK5(1,1)'    \
      -stim_label 9 RewardBurst                              \
      -stim_times 10 Control_pump_times.1D 'BLOCK5(1,1)' \
      -stim_label 10 ControlPump \
      -stim_times 11 Control_points_times.1D 'BLOCK5(1,1)' \
